  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(size: 597.0, end: -401.0),
            Pin(size: 597.0, start: -367.0),
            child: Container(
          ...
          Pinned.fromPins(
            Pin(size: 383.0, start: -69.0),
            Pin(size: 383.0, start: -102.0),
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
                    BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
          ...
          Pinned.fromPins(
            Pin(size: 225.0, end: -34.0),
            Pin(size: 225.0, start: 74.0),
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
                    BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
